...
public class Console {
     ...
     * */
    // TODO: нужно ли оборачивать в NullPointer весь функционал, который вызывает эту функцию, из-за того, что она может вернуть null
     ...
     * */
    // TODO: нужно ли оборачивать в NullPointer весь функционал, который вызывает эту функцию, из-за того, что она может вернуть null
    // TODO: насколько я прочила, если реализована readMarkBoolean, то здесь нужно перейти на её использование,
    // TODO: и в зависимости от того, что она возвращает(true, false), тут возвращать(1,0 соответсвенно)
    public int readMark(){
        // обработчика на пустое значение нет, т.к. подобная реализация не считает пустую строку
        Integer mark = null;
        String  readOurSout;
     ...
     * */
    // TODO: как вариант - этот метод должен быть в классе SortType
    // TODO: нужно ли оборачивать в NullPointer весь функционал, который вызывает эту функцию, из-за того, что она может вернуть null
    ...
    // TODO: не закончен, дописать, работу с самим файлом
    public static void fillFile(String fileName, List listName){
        // TODO: тут предусмотреть вариант, что переданная коллекция может быть пустой
        // TODO: и желаемое поведение - затереть файл, сделать его с пустым содержанием
     ...
     * */
    // TODO: нужно ли оборачивать в NullPointer весь функционал, который вызывает эту функцию, из-за того, что она может вернуть null
    // TODO: мне не очень нравится это реализация, по-хорошему бы ещё продумать, что именно просить у пользователя
    // TODO: (1, 0) или всё-таки (да, нет)
    public boolean readMarkBoolean(){
        // обработчика на пустое значение нет, т.к. подобная реализация не считает пустую строку
        Integer mark = null;
        boolean markBoolean = false;
        String  readOurSout;
        Scanner scannerIn = new Scanner(System.in);
